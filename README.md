...
- [Part II — Software Architecture](#part-ii--software-architecture)
- [Part III — Controller Configuration](#part-iii--controller-configuration)
- [Part IV — Motion Planning & Execution](#part-iv--motion-planning--execution)
- [Part V — Verification & Debugging](#part-v--verification--debugging)
- [Part VI — Repository Structure](#part-vi--repository-structure)
...
It documents the complete workflow from package creation to motion planning, controller configuration, execution, verification, and debugging on a real Franka FR3 robot.
...
## Part III — Controller Configuration
...
## Part IV — Motion Planning & Execution
