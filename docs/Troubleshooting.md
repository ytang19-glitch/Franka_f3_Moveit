...
- [Overview](#overview)
- [Part I — ROS 2 & Environment](#part-i--ros-2--environment)
- [Part II — Debug Checklist](#part-ii--debug-checklist)
- [Part III — Franka Gripper Debugging](#part-iii--franka-gripper-debugging)
- [Part IV — MoveItPy & Motion Planning](#part-iv--moveitpy--motion-planning)
- [Part V — Development Log (July 16–21)](#part-v--development-log-july-1621)
...
The troubleshooting content is organized into ROS 2 environment issues, debugging checklists, Franka gripper debugging, MoveItPy motion-planning debugging, development logs, and useful commands.

---

# Part I — ROS 2 & Environment
...
# Part III — Franka Gripper Debugging
...
# Part IV — MoveItPy & Motion Planning
...
# Part V — Development Log (July 16–21)
...
The commands below are already explained in the corresponding troubleshooting sections.
...
## Package and Executable Verification
...
## Controller and Hardware Verification
